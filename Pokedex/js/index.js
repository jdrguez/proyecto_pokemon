...
const showPokedex = async () => {
    ...
    for(var i = 0; i < pokemons.length; i++) {
        ...
        pokedex.innerHTML +=    `<div class="card ${tipo1} ${tipo2}">
                                    ...
                                    <div class="container-hei-wei">
                                        <div class="height_weight">
                                            <img class="height" src="assets/images/altura.png">${pokemons[i].pkm_height / 10} m 
                                            <img class="weight" src="assets/images/peso.png">${pokemons[i].pkm_weight / 10} kg
                                        </div>
                                    <div class="types">
                                        ${tipo1} ${tipo2}
                                    </div>
